...
<head>
  ...
  <title>UTM - Universitas Teknologi Mataram</title>
  ...
  <!-- Favicons -->
  <link href="logoutm.png" rel="icon">
  <link href="logoutm.png" rel="apple-touch-icon">
    ...
    <div class="container d-flex align-items-center">
      ...
      <div class="logo me-auto">
        ...
        <!-- Uncomment below if you prefer to use an image logo -->
         <h4><a href="./"><img src="logoutm.png"class="img-fluid"> <b style="color: #3F51B5">Universitas </b> <b style="color: #F00707">Teknologi</b> <b style="color: #3F51B5"> Mataram</b></a></h4>
      </div>
...
<!--       <div class="header-social-links d-flex align-items-center">
  ...
  <footer id="footer">
    ...
    <div class="container">
      <div class="copyright">
        &copy; 2021 <strong><span>UTM - MATARAM</span></strong>. All Rights Reserved
      </div>
      <div class="credits">
