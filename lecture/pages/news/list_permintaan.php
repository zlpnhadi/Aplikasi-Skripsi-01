          ...
          <div class="card">
            <div class="card-header">
              <table width="100%" style="border-bottom: 5px double;">
                  <tr>
                  <td align="center"> <img src="../logoutm.png"/ class="img-fluid" width="90"></td>
                  </tr>
                  <tr>
                  <td align="center">
                  <h4><strong style="text-transform: uppercase;">FAKULTAS <?= $detail['fakultas'] ?></strong></h4>
                  <h5><strong style="text-transform: uppercase;">PRODI <?= $detail['prodi'] ?></strong></h5>
                  <p align="center"><em>Alamat : Jalan Kampus Universitas Teknologi Mataram, Kekalik Jaya, Kota Mataram, NTB 83126</em></p>
                  </td>
                  </tr>
                  </table>
                  ...
                  Fakultas <?= $detail['fakultas'] ?> Universitas Teknologi Mataram, Maka bersama ini dimohon kesediaan Bapak/Ibu sebagai pembimbing Skripsi Mahasiswa dibawah ini :
                  </p>
            </div>
