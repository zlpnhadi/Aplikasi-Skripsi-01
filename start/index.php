              ...
              <div class="col-lg-12">
                <div class="login-form">
                  <div class="text-center">
                  	<img src="../logoutm.png" class="img-fluid" width="100">
                    <hr>
                    <h1 class="h4 text-gray-900 mb-4">Login <b>UTM</b></h1>
                  </div>
                  <p>
            <?php 
        if ($_SERVER['REQUEST_METHOD']=='POST') {
        $userKey = mysqli_real_escape_string($con,$_POST['userkey']);
        $userPin= md5(mysqli_real_escape_string($con,$_POST['userpin']));
        ...
        ?>
                  ...
                  <form method="POST" class="user">
                    <div class="form-group">
                      <input type="text" name="userkey" class="form-control"
